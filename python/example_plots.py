...
Gamma2_Ar = 0.374e-3;# Speed dependence of the line-width in cm-1.
Delta0_Ar = -26.4e-3;# Speed-averaged line-shift in cm-1.
Delta2_Ar = 17.8e-3;# Speed dependence of the line-shift in cm-1.
...
Gamma2_He = 5.4e-3;# Speed dependence of the line-width in cm-1.
Delta0_He = 30.5e-3;# Speed-averaged line-shift in cm-1.
Delta2_He = 12.4e-3;# Speed dependence of the line-shift in cm-1.
...
y_Ar = [mHT.profile(nu0,GammaD,Gamma0_Ar,Gamma2_Ar,Delta0_Ar,Delta2_Ar,NuOptRe_Ar,NuOptIm_Ar,nu,Ylm=Ylm,Xlm=Xlm,alpha=alpha_Ar,disp=True) for nu in x]
y_He = [mHT.profile(nu0,GammaD,Gamma0_He,Gamma2_He,Delta0_He,Delta2_He,NuOptRe_He,NuOptIm_He,nu,Ylm=Ylm,Xlm=Xlm,alpha=alpha_He,disp=True) for nu in x]
...
plt.clf()
# Comparing absorption (real part of the mHT) for H2-Ar and H2-He cases.
plt.plot(x,list(map(list,zip(*y_Ar)))[0])
