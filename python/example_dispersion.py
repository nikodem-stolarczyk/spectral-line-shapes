...
print(mHT.profile(nu0,GammaD,Gamma0,Gamma2,Delta0,Delta2,NuOptRe,NuOptIm,nu,disp=True)[1]) 
# The mHT function returns a table with real and imaginary part of the output when 'disp' key word is set to True.
# The part [1] is its imaginary part, representing the dispersion profile.
