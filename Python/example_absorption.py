try: 
  ...
  raise SystemExit (str(msg) + '\nexample_absorption.py: mHT not found. Make sure catalog with mHT module is in same catalog as running script and is named "mHT"!')
...
print(mHTprofile(nu0,GammaD,Gamma0,Gamma2,Delta0,Delta2,NuOptRe,NuOptIm,nu)) # The mHT function output returns absorption profile by default.
