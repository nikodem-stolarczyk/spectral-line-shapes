...
CPFa = Compile[{{x,_Real},{y,_Real}}, Block[{z,L=5.449631621480024},
       z=-y+x I ;
       0.5641895835477563/(L-z)+2/(L-z)^2 Total[((L+z)/(L-z))^Range[36,0,-1]
       {-3.129493160727961 10^(-14), -1.188364999909099 10^(-14), +1.951777029849348 10^(-13), +1.790586243645278 10^(-13),
        ...
        +2.975931371735470 10^(+00)}]],
       RuntimeAttributes->{Listable},Parallelization->True,RuntimeOptions->"Speed"];

CPFf = Compile[{{x,_Real},{y,_Real}}, Block[{z,L=4.119534287814236},
       z=-y+x I;
       0.5641895835477563/(L-z)+2/(L-z)^2 Total[((L+z)/(L-z))^Range[23,0,-1]  
       {-1.513747622620502 10^(-10), +4.904820407381768 10^(-09), +1.331045329581992 10^(-09), -3.008282344381996 10^(-08),
        ...
        +9.257087138588670 10^(-01), +1.394819673379119 10^(+00), +1.856286499205540 10^(+00), +2.197858936531542 10^(+00)}]],
       RuntimeAttributes->{Listable},Parallelization->True,RuntimeOptions->"Speed"];
...
mHT[\[Nu]0_,\[CapitalGamma]D_,\[CapitalGamma]0_,\[CapitalGamma]2_,\[CapitalDelta]0_,\[CapitalDelta]2_,Re\[Nu]opt_,Im\[Nu]opt_,\[Nu]_,Sw_:1.0,Ylm_:0.0,Xlm_:0.0,\[Alpha]_:10.0]:=Block[
       {X,Y,csqY,z1,z2,z,r,w1,w2,w,A,Output,
       cpf    = CPFa,
